                        ...
                        <tbody className="text-black font-bold text-xs rllt-condensed">
                            ...
                            {chunk.days.map(d => (
                                <tr key={d.id} className="bg-white text-center border-b-2 border-black h-[22px]">
                                    ...
                                    <td className="border-2 border-black p-0 bg-white overflow-hidden" style={{ fontSize: getFS(23) }}>
                            ...
                            <tr className="bg-white text-center font-extrabold h-[22px]">
                                ...
                                <td className="border-2 border-black bg-white text-center" style={{ fontSize: getFS(23) }}>{formatSum(m3Total, 'HrMins')}</td>
