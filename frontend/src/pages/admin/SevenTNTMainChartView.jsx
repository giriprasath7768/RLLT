...
const SevenTNTMainChartView = () => {
    ...
    const [headerTitle, setHeaderTitle] = useState("7TNT Main Chart Viewer");
            ...
            if (data.state_payload) {
                try {
                    ...
                    if (Array.isArray(parsed)) {
                        setChunks(parsed);
                        if (parsed.length === 8) {
                            setHeaderTitle("40 Days 7TNT Main Chart Viewer");
                        } else {
                    ...
                    <div className="w-full border-[3px] border-black p-3 flex flex-col bg-white overflow-hidden">
                        ...
                        <div className="flex flex-col w-full mb-2">
                                ...
                                <tbody>
                                    <tr className="h-[55px]">
                                        <td className="w-[55px] bg-[#00b050] border-r-2 border-black p-0 align-middle">
                                            <div className="w-full h-full flex items-center justify-center"><span className="text-white font-serif text-[32px] font-normal leading-none" style={{ transform: 'translateY(-2px)' }}>{tLabel}</span></div>
                                        </td>
                            ...
                            <table className="w-full bg-white table-fixed border-collapse border-b-2 border-l-2 border-r-2 border-black" style={{ borderSpacing: 0 }}>
                                <tbody>
                                    <tr className="h-[65px]">
                                        <td className="w-[85px] border-r-2 border-black p-0 align-middle bg-white"><div className="w-[85px] h-[65px] p-1"><ImageBox url={logoUrl} label="" /></div></td>
                                        <td className="w-[85px] border-r-2 border-black p-0 align-middle bg-white"><div className="w-[85px] h-[65px] p-1"><ImageBox url={logoUrl} label="" /></div></td>
                                        <td className="w-[85px] border-r-2 border-black p-0 align-middle bg-white"><div className="w-[85px] h-[65px] p-1"><ImageBox url={logoUrl} label="" /></div></td>
                                ...
                                {chunks.map((chunk, cIdx) => (
                                    <tbody key={chunk.id} className="text-black font-bold text-sm rllt-condensed">
                                        <tr className="bg-white text-center border-b-2 border-black h-[40px]">
                                            <td colSpan={2} className="border-2 border-black p-0 bg-gray-50 align-middle text-center overflow-hidden relative  hover:bg-gray-100 transition-colors group">
                                                {chunk.headerImage ? (
                                            ...
                                            <td className="border-2 border-black p-0 align-middle bg-white font-extrabold text-black">
                                                {chunk.dayLabel !== undefined ? chunk.dayLabel : `DAY ${chunk.days.map(d => d.day).join(', ')}`}
                                            </td>
                                        ...
                                        {chunk.days.map((d, dIdx) => (
                                            <tr key={d.id} className="bg-white text-center border-b-2 border-black h-[38px]">
                                                ...
                                                {/* CHECKBOX */}
                                                <td className="border-2 border-black p-0 text-center align-middle hover:bg-gray-100 " onClick={() => {
                                                    const newChunks = [...chunks];
...
export default SevenTNTMainChartView;
