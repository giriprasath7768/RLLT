        ...
        return (
            <div className="flex flex-col">
                <div
                    ...
                    className={`flex items-center justify-between ${paddingLeft} ${paddingRight} ${paddingY} cursor-pointer transition-all duration-200 border-l-4 border-transparent text-gray-300 hover:bg-gray-700 hover:text-white`}
                >
