        ...
        for b in blocks:
            if b.get('type') == 0:  # text block
                ...
                if paragraph_text:
                    ...
                    # HTML Generation
                    para_idx = len(page_data["paragraphs"])
                    html_content.append(f"    <p class='pdf-selectable-paragraph my-4 text-lg leading-relaxed font-serif' id='para-{page_num + 1}-{para_idx}'>{paragraph_text}</p>")
